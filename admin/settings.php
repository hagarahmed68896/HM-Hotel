                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="site_title" id="site_title_inp" class="form-control shadw-none" required>
                                    </div>
                                    <div class="mb-3 ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="address" id="address_inp" class="form-control shadw-none" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Google Map Link</label>
                                                <input type="text" name="gmap" id="gmap_inp" class="form-control shadw-none" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" name="email" id="email_inp" class="form-control shadw-none" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="iframe" id="iframe_inp" class="form-control shadw-none" required>
                                            </div>
    ...
    <script>
        ...
        function upd_shutdown(val) {
            ...
            xhr.onload = function () {
                if (this.responseText == 1) {
                    if (val == 0) {
                        alert('success', 'Site has been turned on!');
                    } else {
                        alert('success', 'Site has been shutdown!');
                    }
                    get_general();
                } else {
                    alert('error', 'Failed to change site state.');
                }
            }
